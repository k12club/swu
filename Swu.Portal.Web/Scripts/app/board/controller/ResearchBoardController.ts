module Swu {
    ...
    export class ResearchBoardController {
        ...
        constructor(private $scope: IResearchBoardScope, private $rootScope: IRootScope, private $state: ng.ui.IState, private webboardService: IwebboardService, private $stateParams: ng.ui.IStateParamsService, private $sce: ng.ISCEService) {
